...
export default function Post() {
  return (
    <>
      <Header title="Where are the product people?" date="March 11, 2024" readingTime="4" />
      ...
      <p className="mb-4">
        ...
        <Link href="https://en.m.wikipedia.org/wiki/Enshittification" target="_blank" space dot>
          enshittification
        </Link>
        .
      </p>
      ...
      <p className="mb-4">
        I am noticing this in the industry as a whole. In many tech companies today, it seems like marketers and
      ...
      <p className="mb-4">
        While marketing and sales are important, they should work together with product experts, not overshadow them.
        It's crucial for companies to remember this balance so they can keep making amazing products that customers will
        love.
      </p>

      <p className="mb-4">
        So sales and marketing folks, if someone working on the product tells you something isn't needed, or that adding
        a feature will take time or even harm the product, please listen. Don't push them with tight deadlines that
        could make them cut corners, so the company can sell more. They understand the product inside out and know what
        it takes to make it truly excellent.
      </p>

      <p className="mb-4">They are the "product people".</p>

      <br />
      <br />

      <video controls>
        <source src="/videos/steve-product-people.mp4" type="video/mp4" />
      </video>
    </>
  );
}
