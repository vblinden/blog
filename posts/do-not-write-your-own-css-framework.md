...
It is very easy to customize Tailwind CSS with for example <a href="https://tailwindcss.com/docs/theme" target="_blank">themes</a>. Want different colors for theme? Different radius? Different text sizes? You can just use <a href="https://developer.mozilla.org/en-US/docs/Web/CSS/CSS_cascading_variables/Using_CSS_custom_properties" target="_blank">CSS custom properties</a> and just import the theme in your company CSS and be done with it.
